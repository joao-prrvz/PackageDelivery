...
('1205', 'Bob', 'Durand', 'Rue de Carouge 85, Geneva', 46.1915, 6.1383, 'Not delivered', 1, CURDATE(), 2, NULL),
('1201', 'Claire', 'Petit', 'Rue de Lausanne 67, Geneva', 46.2140, 6.1479, 'Not delivered', 1, CURDATE(), 2, NULL),

('1206', 'David', 'Morel', 'Avenue de Champel 24, Geneva', 46.1929, 6.1532, 'Not delivered', 1, CURDATE(), 3, NULL),
('1205', 'Emma', 'Favre', 'Rue de l’École-de-Médecine 20, Geneva', 46.1978, 6.1437, 'Not delivered', 1, CURDATE(), 3, NULL),

('1205', 'Felix', 'Lambert', 'Rue des Bains 23, Geneva', 46.2012, 6.1389, 'Not delivered', 1, CURDATE(), 4, NULL),
('1205', 'Gina', 'Roche', 'Boulevard Georges-Favon 20, Geneva', 46.2025, 6.1375, 'Not delivered', 1, CURDATE(), 4, NULL),

('1203', 'Hugo', 'Girard', 'Rue de la Servette 90, Geneva', 46.2163, 6.1288, 'Not delivered', 1, CURDATE(), 5, NULL),
('1217', 'Iris', 'Bertrand', 'Rue de Meyrin 49, Geneva', 46.2231, 6.1104, 'Not delivered', 1, CURDATE(), 5, NULL),
